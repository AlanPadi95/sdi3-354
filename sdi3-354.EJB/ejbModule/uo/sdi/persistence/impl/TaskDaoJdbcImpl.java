...
public class TaskDaoJdbcImpl implements TaskDao {
	...
	@Override
	public List<Task> findCreatedNotFinished(Long userId) {
		return jdbcTemplate.queryForList(
				"TASK_FIND_CREATED_NOT_FINISHED_BY_USER_ID",
				new TaskDtoMapper(), userId);
	}

	@Override
	public List<Task> findInboxNotFinishedTasksByUserId(Long userId) {
		return jdbcTemplate.queryForList(
				"TASK_FIND_NOT_FINISHED_INBOX_BY_USER_ID", new TaskDtoMapper(),
				userId);
	}

	@Override
	public List<Task> findTaskFinishedPendingByCategoryId(Long categoryId) {

		return jdbcTemplate.queryForList(
				"TASK_FIND_FINISHED_PENDING_TASK_BY_CATEGORY_ID",
				new TaskDtoMapper(), categoryId);
	}
